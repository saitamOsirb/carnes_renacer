...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <section className="section container">
        ...
        <div className="category-grid">
          {categories.map((category) => {
            const sample = products.find((product) => product.category === category) ?? products[0];
      ...
      <section className="trust-banner container"><div><strong>+200</strong><span>clientes atendidos</span></div><div><strong>100%</strong><span>cadena de frío</span></div><div><strong>Compra protegida</strong><span>pago en integración</span></div><div><strong>Antofagasta</strong><span>cobertura local</span></div></section>
      <ContactSection />
    </>
  );
}
